...
def append_en_content(doc):
    ...
    logs = [
        ("19 June 2026", "Code Refactoring",
         "Optimised PySpark join strategies and CrossValidator implementation for the Gold layer machine learning model."),
        ("20 June 2026", "Proposal Draft",
         "Reviewed technical documentation gaps, structured methodology section, and aligned content with rubric requirements."),
        ("20 June 2026", "System Design",
         "Refined Star Schema definitions, use case descriptions, and testing strategy documentation.")
    ]
...
def append_id_content(doc):
    ...
    logs = [
        ("19 Juni 2026", "Code Refactoring",
         "Mengoptimalkan strategi join PySpark dan implementasi CrossValidator untuk model pembelajaran mesin lapisan Gold."),
        ("20 Juni 2026", "Draf Proposal",
         "Meninjau celah dokumentasi teknis, menyusun bagian metodologi, dan menyelaraskan konten dengan persyaratan rubrik."),
        ("20 Juni 2026", "Desain Sistem",
         "Menyempurnakan definisi Star Schema, deskripsi use case, dan dokumentasi strategi pengujian.")
    ]
    for i, (d, t, u) in enumerate(logs):
        r = g_table.rows[i+1].cells
        r[0].text, r[1].text, r[2].text = d, t, u
